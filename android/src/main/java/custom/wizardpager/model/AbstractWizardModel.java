...
public abstract class AbstractWizardModel implements ModelCallbacks, Serializable {
    ...
    /** The m root page list. */
    private final PageList mRootPageList;

    /**
     * Instantiates a new abstract wizard model.
     *
    ...
    /* (non-Javadoc)
     * @see java.custom.wizardpager.model.ModelCallbacks#onPageDataChanged(Page)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see java.custom.wizardpager.model.ModelCallbacks#onPageTreeChanged()
     */
    @Override
     ...
     * Load.
     *
     * @param savedValues the saved values
     */
     ...
     * user's choices.
     *
     * @return the current page sequence
     */
