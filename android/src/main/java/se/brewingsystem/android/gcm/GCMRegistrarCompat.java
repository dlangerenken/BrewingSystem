...
/**
 * The Class GCMRegistrarCompat.
 */
class GCMRegistrarCompat {
    
    /** The Constant TAG. */
    private static final String TAG = "GCMRegistrar";
    
    /** The Constant INTENT_FROM_GCM_MESSAGE. */
    private static final String INTENT_FROM_GCM_MESSAGE =
            "com.google.android.c2dm.intent.RECEIVE";
    
    /** The Constant PERMISSION_GCM_INTENTS. */
    ...
    /** The Constant REGISTRATION_EXPIRY_TIME_MS. */
    ...
    /**
     * check permission
     * @param permissionName - permission which is required
     * @param packageManager - manager which is used for the lookup
     */
    private static void checkPermission(String permissionName,PackageManager packageManager){
        try {
     ...
     * @param packageManager - manager which is used for the lookup
     */
    private static Set<String> checkReceivers(PackageManager packageManager, String packageName){
        // check receivers
    ...
    public static void checkManifest(Context context) {
        ...
        checkPermission(permissionName, packageManager);
        Set<String> allowedReceivers = checkReceivers(packageManager, packageName);
    ...
    /**
     * Checks if is registration expired.
     *
     * @param context the context
     * @return true, if is registration expired
     */
    ...
    /**
     * Instantiates a new GCM registrar compat.
     */
    ...
    /**
     * The Class BaseRegisterTask.
     */
    abstract static public class BaseRegisterTask extends
        ...
        /**
         * Instantiates a new base register task.
         *
         * @param context the context
         */
