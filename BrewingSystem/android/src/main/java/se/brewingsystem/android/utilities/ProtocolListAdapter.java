 ...
 */
public class ProtocolListAdapter extends ArrayAdapter<LogSummary> {
    
    /** The m context. */
    private final Context mContext;

    /**
     * Instantiates a new protocol list adapter.
     *
     * @param context the context
     * @param protocols the protocols
     */
    public ProtocolListAdapter(final Context context, List<LogSummary> protocols) {
        super(protocols);
        mContext = context;
    }
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        ViewHolder holder;
        if (view == null) {
            view = LayoutInflater.from(mContext).inflate(R.layout.protocol_list_item, parent, false);
