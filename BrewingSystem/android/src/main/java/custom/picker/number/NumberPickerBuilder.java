...
public class NumberPickerBuilder {
    ...
    /** The plus minus visibility. */
    private Integer plusMinusVisibility;
    
    /** The decimal visibility. */
    ...
    private final Vector<NumberPickerDialogFragment.NumberPickerDialogHandler> mNumberPickerDialogHandlers = new Vector<>();
    ...
    public NumberPickerBuilder setStyleResId(int styleResId) {
        Integer styleResId1 = styleResId;
        return this;
    }
